 ...
 <div class="row content ">
	...
	<div class=" col-xs-8 col-sm-8 col-md-8 col-lg-8 center" id="center" >
		...
		<div class="form_container" id="formContainer">
			<form class="form" method="POST" action="addUser"" id="form-signin" modelAttribute="userForm" class="form-signin" >
			  <div class=" col-xs-7 col-sm-7 col-md-7 col-lg-7 center" id="center">
			    <input type="text" class="form-control form-control-lg" id="fName"  name="fName" aria-describedby="" 
			    placeholder="First Name" required>
			    <br>
			    <input type="text" class="form-control form-control-lg" id="lName"  name="lName" aria-describedby="" 
			  ...
			  <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 center">
			    ...
			    <br>
			     ...
			     <input type="password" class="form-control form-control-lg" placeholder="Confirm Password" id="confirm_password" name="confirm_password" required>
			    <br>
			   
			     <input type="text" class="form-control form-control-lg" placeholder="Bank" id="bank" >
			     			    <br>
			   
			     <input type="text" class="form-control form-control-lg" placeholder="Bank Website" id="bankWebSite" >
