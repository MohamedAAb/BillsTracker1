    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">Add payee</a>
...
<div class="row content ">
	...
	<div class=" col-xs-8 col-sm-8 col-md-8 col-lg-8 center" id="center" >
		...
		<div class="form_container" id="formContainer">
			<form class="form" method="POST" action="addPayee"" id="form-signin" modelAttribute="userForm" class="form-signin" >
			  <div class=" col-xs-7 col-sm-7 col-md-7 col-lg-7 center" id="center">
			    <input type="text" class="form-control form-control-lg" id="payeeName"  name="payeeName" aria-describedby="" 
			    placeholder="Payee Name" required>
			    <br>
			    
			     <input type="text" class="form-control form-control-lg" id="billType"  name="billType" aria-describedby="" 
			    placeholder="Bill Type" required>
			    
			   
				<br>
			    <input type="text" class="form-control form-control-lg" id="service"  name="service" aria-describedby="" 
			    placeholder="Service" required >
			    <br>
			   
			    <input type="text" class="form-control form-control-lg" id="website"  name="website" aria-describedby="emailHelp" 
